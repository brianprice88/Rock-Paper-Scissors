    ...
    return (
        <div className="container-fluid scoreboard">
            <div className="row">
                ...
                <div className="col-lg-8" style={{ textAlign: 'center' }}><h1>First to {props.toWin} wins!</h1> </div>
            ...
            <div className="row">
                ...
                <div className="col-lg-8" style={{ textAlign: 'center' }}><h1>Welcome to {props.room} room</h1> </div>
                <div className="col-lg-2">
                    {!props.isPlayer1 ? <h1>{props.name}</h1> : <h1>{props.opponent}</h1>}
                </div>
            </div>
